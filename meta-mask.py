...
locations = rng.choice(['1','2','3','4'],numStim)
soaTimes  = (rng.random(numStim)*(maxSOA-minSOA)) + minSOA
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Stephen\\Desktop\\projects\\meta_mask\\meta-mask.py',
...
_key_resp_allKeys = []
# keep track of which components have finished
start_mainComponents = [text, key_resp]
